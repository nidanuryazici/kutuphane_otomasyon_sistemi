...
<section id="menu">
  <div id="logo">“Bir kitap, sadece raflarda değil; insanın hayatında da yer açar.”</div>
  <nav>
    <?php if ($girisli): ?>
    ...
    <?php else: ?>
      <?php foreach ($sonuclar as $kitap): ?>
        <div class="kitap-kart">
          ...
          <?php else: ?>
            <div class="kitap-aksiyon">
              <a class="btn-mini" href="giris.php?return=<?php echo urlencode($return_uri); ?>">Favori / Ayırt için giriş yap</a>
            </div>
          <?php endif; ?>
